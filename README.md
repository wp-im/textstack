...
The optional `Textstack Showcase` page template provides a full-width, content-led surface for a product page, theme guide, or publication introduction. The template contains no site-specific marketing copy; its content remains in the WordPress page.
...
The release script creates `build/textstack-1.0.1.zip` with the theme folder at the ZIP root and excludes project documentation, build output, VCS files, and local data. See `docs/release-checklist.md` for the full review sequence.
